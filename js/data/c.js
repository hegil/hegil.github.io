...
COURSES.c = {
    ...
    units: [{
      id: 'intro',
      title: 'C 언어는 어떤 언어인가요?',
      ready: true,
      intro: true,
      summary: 'C 언어가 무엇이고, 어디에 쓰이고, 왜 배우면 좋은지 알아봐요.',
      blocks: [
        {
          h: 'C 언어는 어떤 언어인가요?',
          html: `<p>C 언어는 1972년에 만들어진, 지금 쓰이는 거의 모든 프로그래밍 언어의 "조상" 격인 언어예요. 컴퓨터가 실제로 데이터를 어떻게 저장하고 처리하는지에 아주 가까운, 낮은 수준의 언어예요.</p>`
        },
        {
          h: '어디에 쓰이나요?',
          html: `<p>운영체제(리눅스 커널 등), 자동차·가전제품 같은 임베디드 기기, 그리고 속도가 아주 중요한 시스템 프로그램에 쓰여요.</p>`
        },
        {
          h: '왜 배우면 좋을까요?',
          html: `<p>메모리를 직접 다뤄야 해서 처음엔 어렵게 느껴질 수 있어요. 하지만 그만큼 컴퓨터가 실제로 어떻게 동작하는지 깊이 이해하게 해줘서, 나중에 어떤 언어를 배우든 그 원리를 훨씬 잘 이해하는 데 도움이 돼요.</p>`,
