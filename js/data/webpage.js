...
COURSES.webpage = {
    ...
    units: [{
      id: 'intro',
      title: 'HTML과 CSS는 어떤 언어인가요?',
      ready: true,
      intro: true,
      summary: 'HTML과 CSS가 무엇이고, 어떤 역할을 나눠 맡고 있고, 왜 배우기 좋은 시작점인지 알아봐요.',
      blocks: [
        {
          h: 'HTML과 CSS는 어떤 언어인가요?',
          html: `<p>HTML은 웹페이지의 "구조"(제목, 문단, 이미지, 버튼 같은 내용물)를 만들고, CSS는 그 위에 "디자인"(색깔, 배치, 크기, 여백)을 입혀요. 이 둘은 항상 짝을 이뤄 함께 쓰여요.</p>`
        },
        {
          h: '다른 언어와 뭐가 다른가요?',
          html: `<p>HTML/CSS는 반복문이나 조건문 같은 "로직"을 담는 프로그래밍 언어가 아니라, 화면에 무엇을 어떻게 보여줄지 정하는 마크업/스타일 언어예요. 하지만 모든 웹사이트의 기본 뼈대이기 때문에, 웹을 다루려면 반드시 알아야 해요.</p>`
        },
        {
          h: '왜 배우면 좋을까요?',
          html: `<p>고친 내용이 화면에 바로 나타나서 결과를 눈으로 즉시 확인할 수 있어요. 그래서 다른 언어보다 진입장벽이 낮고, 완전 처음 코딩을 시작하는 사람에게도 추천되는 좋은 시작점이에요.</p>`,
