...
COURSES.php = {
    ...
    units: [{
      ...
      ready: true,
      intro: true,
      summary: 'PHP가 무엇이고, 어디에 쓰이고, 왜 배우면 좋은지 알아봐요.',
      blocks: [
        {
          h: 'PHP는 어떤 언어인가요?',
          html: `<p>PHP는 1994년, 웹페이지를 동적으로 만들기 위해 태어난 언어예요. 웹 서버와 함께 동작하도록 처음부터 설계돼서, 요청이 들어올 때마다 필요한 내용을 만들어 보여주는 데 특화돼 있어요.</p>`
        },
        {
          h: '어디에 쓰이나요?',
          html: `<p>워드프레스를 비롯해 전 세계 웹사이트의 상당수가 PHP로 만들어져 있어요. 지금도 웹 백엔드(서버 쪽) 개발에서 아주 널리 쓰이는 언어예요.</p>`
        },
        {
          h: '왜 배우면 좋을까요?',
          html: `<p>회원가입·로그인, 게시판, 데이터베이스 연동 같은 실제 웹 기능을 빠르게 만들 수 있어요. 웹 개발을 배우고 싶다면 실전 감각을 익히기 좋은 언어예요.</p>`,
